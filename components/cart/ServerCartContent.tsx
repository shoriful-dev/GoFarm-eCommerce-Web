            ...
            {cart.map((item, idx) => {
              ...
              const originalPrice =
                (
                  ...
                  ? price /
                    (1 -
                      ((item.product as unknown as { discount?: number })
                        .discount || 0) /
                        100)
                  : null;
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    idx !== cart.length - 1 &&
                      "border-b border-gofarm-light-gray",
                  )}
                >
                  {/* Product cell */}
                  <div className="flex gap-3 sm:gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {(item.product.categories ||
                        (item.product as unknown as { color?: string })
                          .color) && (
                      ...
                      {/* Rating */}
                      {(item.product as unknown as { rating?: number })
                        .rating !== undefined && (
                  ...
                  <div className="mt-3 md:mt-0 flex items-center gap-2 md:block">
                    <span className="md:hidden text-xs text-gofarm-gray">
                      Price:
                    </span>
                  ...
                  <div className="mt-3 md:mt-0">
                    <span className="md:hidden block text-xs text-gofarm-gray mb-1">
                      Quantity
                    </span>
          ...
          {isAuthenticated &&
            (() => {
              ...
              const remaining = Math.max(
                0,
                FREE_SHIP_THRESHOLD - subtotalAfterCoupon,
              );
              const pct =
                FREE_SHIP_THRESHOLD > 0
                  ? Math.min(
                      100,
                      (subtotalAfterCoupon / FREE_SHIP_THRESHOLD) * 100,
                    )
                  : 100;
              return (
 ...
 */
function FavoriteCartButton({
  product,
}: {
  product: import("@/sanity.types").Product;
}) {
