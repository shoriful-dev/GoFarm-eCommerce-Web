        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          >
            <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 border border-gray-100">
              <h2 className="text-2xl font-bold text-gofarm-green mb-6">Contact Information</h2>
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-gofarm-green mb-1">{info.title}</h3>
                      {info.href ? (
                        <a
                          href={info.href}
                      ...
                      <p className="text-gofarm-gray text-xs">{info.subDetails}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
          ...
          >
            <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 border border-gray-100">
              <h2 className="text-2xl font-bold text-gofarm-green mb-6">Send us a Message</h2>

              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-gofarm-green font-medium">
                      Full Name *
                    </Label>
                    <Input
                      disabled={loading}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-gofarm-green font-medium">
                      Email Address *
                    </Label>
                    <Input
                      disabled={loading}
                ...
                <div className="space-y-2">
                  <Label htmlFor="subject" className="text-gofarm-green font-medium">
                    Subject *
                  </Label>
                  <Input
                    disabled={loading}
                ...
                <div className="space-y-2">
                  <Label htmlFor="message" className="text-gofarm-green font-medium">
                    Message *
                  </Label>
                  <Textarea
                    disabled={loading}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                <h3 className="font-semibold text-gofarm-green mb-2">{faq.q}</h3>
