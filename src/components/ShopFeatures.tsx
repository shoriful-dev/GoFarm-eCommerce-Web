            ...
            return (
              ...
              >
                ...
                <div className="text-center space-y-2">
                  ...
                  <p className="text-sm text-gofarm-gray leading-relaxed">{feature.description}</p>
        ...
        <div className="mt-12 pt-8 border-t border-gofarm-light-green/20">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <div className="text-sm text-gofarm-gray font-medium">Happy Customers</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold bg-linear-to-r from-gofarm-green to-gofarm-light-green bg-clip-text text-transparent mb-2">
                100K+
              </div>
              <div className="text-sm text-gofarm-gray font-medium">Products Sold</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold bg-linear-to-r from-gofarm-green to-gofarm-light-green bg-clip-text text-transparent mb-2">
                99%
              </div>
              <div className="text-sm text-gofarm-gray font-medium">Satisfaction Rate</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold bg-linear-to-r from-gofarm-green to-gofarm-light-green bg-clip-text text-transparent mb-2">
                24/7
              </div>
              <div className="text-sm text-gofarm-gray font-medium">Customer Support</div>
            </div>
          </div>
        </div>
