    ...
    <div className="fixed inset-0 w-full h-full bg-linear-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center z-50 overflow-hidden">
      ...
      <div className="relative flex flex-col justify-center items-center gap-10 max-w-md mx-auto px-6">
        ...
        <motion.div
          ...
          className="relative bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-200/50 p-8 w-full max-w-sm min-w-[400px]"
        >
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="flex justify-center mb-6 h-[120px] items-center"
            >
        ...
        >
          Powered by{" "}
          <span className="font-semibold text-gofarm-green">GoFarm</span>
        </motion.p>
      </div>
    </div>
  );
