      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 md:py-16">
        <div className="max-w-xl">
          <h2 className="text-3xl md:text-5xl font-bold text-white leading-tight mb-6 md:mb-8 drop-shadow-lg">
            ...
            and get <span className="text-gofarm-light-orange">$10 discount</span>
          </h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3" noValidate>
            ...
            <label className="flex items-center gap-2 text-white text-sm select-none">
              <input type="checkbox" defaultChecked className="w-4 h-4 accent-gofarm-orange" />
              <span>
                I accept{' '}
                <Link href="/terms" className="underline hover:text-gofarm-light-orange">
                  terms and conditions
                </Link>{' '}
                &{' '}
                <Link href="/privacy-policy" className="underline hover:text-gofarm-light-orange">
                  privacy policy
                </Link>
              </span>
            </label>
