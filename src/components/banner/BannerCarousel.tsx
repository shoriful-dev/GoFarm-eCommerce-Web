        ...
        <CarouselContent>
          {banners.map((banner, index) => (
            <CarouselItem key={banner._id}>
              <div className="relative h-75 md:h-100 lg:h-75 w-full overflow-hidden">
                  ...
                  <div className="container mx-auto px-4 md:px-6 lg:px-8">
                    <div className="max-w-xl lg:max-w-2xl space-y-6 md:space-y-8">
                      ...
                      <div className="animate-fadeInUp delay-200">
                        ...
                        >
                          <span className="absolute inset-0 bg-gofarm-green -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-out"></span>
            ...
            {banners.map((_, index) => (
              <button
                ...
                className={`h-2 rounded-full transition-all duration-300 ${
                  current === index + 1 ? 'w-8 bg-white' : 'w-2 bg-white/40 hover:bg-white/60'
                }`}
