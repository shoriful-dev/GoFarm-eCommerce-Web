...
import { Columns2, Grid2x2, Grid3x3, Rows3, List, Filter, SortAsc, Eye } from 'lucide-react';
...
const ProductGrid = () => {
  ...
  const [filteredProducts, setFilteredProducts] = useState<ALL_PRODUCTS_QUERY_RESULT>([]);
  ...
  const query = `*[_type == "product" && references($variantId)] | order(${getSortQuery(sortBy)}){
  ...,
  "categories": categories[]->title,
  "variant": variant->{title, slug}
}`;
    ...
    <Container className="flex flex-col lg:px-0 mt-16 lg:mt-24">
      ...
      {carouselsLoading ? (
        <div className="space-y-6 mb-12">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-96 bg-gofarm-light-gray/30 rounded-2xl animate-pulse" />
          ))}
        </div>
      ) : (
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mt-6 pt-6 border-t border-gofarm-light-gray">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-gofarm-black hidden sm:block">View:</span>
              <div className="flex items-center gap-1">
                <ViewModeButton mode="grid-2" icon={<Columns2 size={16} />} label="2 Columns" />
                <ViewModeButton mode="grid-3" icon={<Grid2x2 size={16} />} label="3 Columns" />
                <ViewModeButton mode="grid-4" icon={<Grid3x3 size={16} />} label="4 Columns" />
                <ViewModeButton mode="grid-5" icon={<Rows3 size={16} />} label="5 Columns" />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex-1">
                            <Label className="text-xs text-gofarm-gray">Min Price</Label>
                            <Input
                              type="number"
                              placeholder="0"
                              value={priceRange[0]}
                          ...
                          <div className="text-gofarm-gray font-bold pt-5">-</div>
                          <div className="flex-1">
                            <Label className="text-xs text-gofarm-gray">Max Price</Label>
                            <Input
                              type="number"
                              placeholder="1000"
                              value={priceRange[1]}
                    ...
                    <div className="flex flex-col gap-3 justify-end p-4 bg-linear-to-br from-gofarm-light-orange/20 to-gofarm-light-orange/10 rounded-xl border border-gofarm-light-green/10">
                      <div className="text-center mb-2">
                        <Label className="text-sm font-bold text-gofarm-black">Quick Actions</Label>
                      </div>
                      <Button
